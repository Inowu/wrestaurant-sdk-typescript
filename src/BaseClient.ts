...
export type BaseClientOptions = {
    environment?: core.Supplier<environments.WrestaurantApiEnvironment | string>;
    /** Specify a custom URL to connect the client to. */
    baseUrl?: core.Supplier<string>;
    /** Override the X-Api-Key header */
    apiKey: core.Supplier<string>;
    /** Override the X-License-Key header */
    licenseKey: core.Supplier<string>;
    ...
    const headers = mergeHeaders(
        {
            ...
            "X-Fern-SDK-Name": "@wrestaurant/sdk",
            "X-Fern-SDK-Version": "0.12.0",
            "User-Agent": "@wrestaurant/sdk/0.12.0",
