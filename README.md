# Wrestaurant TypeScript Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2FInowu%2Fwrestaurant-sdk-typescript)
[![npm shield](https://img.shields.io/npm/v/@wrestaurant/sdk)](https://www.npmjs.com/package/@wrestaurant/sdk)

The Wrestaurant TypeScript library provides convenient access to the Wrestaurant APIs from TypeScript.
...
```sh
npm i -s @wrestaurant/sdk
```

## Reference

A full reference for this library is available [here](https://github.com/Inowu/wrestaurant-sdk-typescript/blob/HEAD/./reference.md).
...
```typescript
import { WrestaurantApiClient, WrestaurantApiEnvironment } from "@wrestaurant/sdk";

const client = new WrestaurantApiClient({
    environment: WrestaurantApiEnvironment.Default,
});
```
...
```typescript
import { WrestaurantApi } from "@wrestaurant/sdk";

const request: WrestaurantApi.GetProductsRequest = {
    ...
};
```
...
```typescript
import { WrestaurantApiError } from "@wrestaurant/sdk";
...
```typescript
const response = await client.endpoints.getFacturaXml(...);
...
```typescript
import { EndpointsClient } from '@wrestaurant/sdk/endpoints';
...
```typescript
const { data, rawResponse } = await client.endpoints.createTempOrders(...).withRawResponse();
...
```typescript
import { WrestaurantApiClient, logging } from "@wrestaurant/sdk";
